...
- Whether the data folder is located at an external drive or a PCIe-connected local drive (HDD or SSD) makes a big difference on preprocessing speed as a large amount of IO is involved.
